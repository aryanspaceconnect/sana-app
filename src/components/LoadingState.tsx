    ...
    <div className="flex w-fit items-center gap-2.5 py-1 my-1">
      <span aria-hidden className="grid grid-cols-[repeat(3,4px)] gap-[1.5px]">
        {delays.map((d, i) => (
          <span
            key={i}
            className={`w-[4px] h-[4px] bg-[#1a1c1e] ${round ? "rounded-full" : "rounded-[1px]"}`}
            style={{
      ...
      <span
        ...
        style={{
          backgroundImage:
            "linear-gradient(90deg, #64748b 35%, #1e293b 50%, #64748b 65%)",
      ...
      <span className="font-mono text-[11.5px] text-[#94a3b8] tabular-nums">
        {elapsed}
      </span>
    </div>
  );
